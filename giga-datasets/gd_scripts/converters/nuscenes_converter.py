...
def main():
    data_dir = './public_datasets/nuscenes/v1.0-mini/'
    save_path = './giga_datasets/public_data/nuscenes/v1.0-mini/'
    NuScenesConverter(data_dir=data_dir, version='v1.0-mini', save_path=save_path, save_version='v0.0.1')()

    # data_path = './giga_datasets/public_data/nuscenes/v1.0-mini/v0.0.1/labels/'
