...
class TEMOS(LightningModule):
    ...
    def __init__(
        ...
        self.motion_encoder = ACTORStyleEncoder(**motion_encoder_cfg)
        self.text_encoder = ACTORStyleEncoder(**text_encoder_cfg)
        self.motion_decoder = ACTORStyleDecoder(**motion_decoder_cfg)
