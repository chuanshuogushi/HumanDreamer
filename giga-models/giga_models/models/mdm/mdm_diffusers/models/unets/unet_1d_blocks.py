...
class DownBlock1D(nn.Module):
    def __init__(self, out_channels: int, in_channels: int, mid_channels: Optional[int] = None, add_downsample: bool = True,):
        super().__init__()
        mid_channels = out_channels if mid_channels is None else mid_channels
...
def get_down_block(
    ...
    if down_block_type == "DownResnetBlock1D":
        ...
        return DownBlock1D(out_channels=out_channels, in_channels=in_channels,add_downsample=add_downsample,)
