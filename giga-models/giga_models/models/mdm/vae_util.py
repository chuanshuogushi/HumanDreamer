...
from .mdm_diffusers.models.unets.unet_1d_blocks import (
    get_down_block,
    get_up_block,
    UNetMidBlock1D,
)
...
class Encoder(nn.Module):
    ...
    Args:
        ...
        down_block_types (`Tuple[str, ...]`, *optional*, defaults to `("DownBlock1D",)`):
    ...
    def __init__(
        ...
        self.mid_block = UNetMidBlock1D(
            ...
            mid_channels=256, # TODO hardcode
            # resnet_eps=1e-6,
            # resnet_act_fn=act_fn,
    ...
    def forward(self, sample: torch.FloatTensor) -> torch.FloatTensor:
        ...
        sample = self.conv_in(sample)  # [64,2,128]-->[64,128,128]
        ...
        if self.training and self.gradient_checkpointing:
            ...
            if is_torch_version(">=", "1.11.0"):
                for down_block in self.down_blocks:
                    ...
                    )  # [64,128,64] [64,256,32] [64,512,16] [64,512,8]
                # middle
                sample = torch.utils.checkpoint.checkpoint(
        ...
        # post-process
        sample = self.conv_norm_out(sample)  # [64,512,8]-->[64,512,8]
        sample = self.conv_act(sample)  # [64,512,8]-->[64,512,8]
        sample = self.conv_out(sample)  # [64,512,8]-->[64,8,8]
